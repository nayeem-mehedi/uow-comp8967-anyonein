...
//     event.preventDefault();
//     try {
//       let queryString = `http://localhost:9001/api/search/project?page=1&limit=${projectsPerPage}`;
...
//       const data = await response.json();
//       setResults(data.data);
//       setTotalProjects(data.total); // Update total projects count
...
//     setCurrentPage(1); // Reset to first page when changing projects per page
//   };
...
//                   style={{ width: 'auto', maxWidth: '120px' }} // Adjust width as needed
//                 >
...
//                   style={{ margin: '0 4px' }} // Optional: adjust spacing
//                 >
//                   {index + 1}
//                 </Pagination.Item>
//               ))}
